...
let _indicatorsCache: IndicatorInfo[] | null = null;
let _brentDataCache: BrentDataPoint[] | null = null;
...
export const getBrentData = (): BrentDataPoint[] => {
  if (!_brentDataCache) {
    _brentDataCache = generateBrentData();
  }
  return _brentDataCache;
};

export const INDICATORS = getIndicators();
export const BRENT_DATA = getBrentData();
