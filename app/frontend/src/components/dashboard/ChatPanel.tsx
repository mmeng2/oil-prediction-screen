    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          bottom: "16px",
          background:
            "linear-gradient(0deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), rgba(118, 118, 118, 0.04)",
      ...
      >
        ...
        <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
          {showForm ? (
            <div className="flex-1 overflow-y-auto p-5 space-y-6 scrollbar-none">
              ...
              <div className="bg-blue-900/10 border border-blue-500/20 p-4 rounded-xl space-y-2">
                ...
                <p className="text-xs text-slate-300 leading-relaxed">
                  基于历史模型推演，该【{formData.type}】事件在【
                  {formData.scope}】范围内持续【{formData.duration}
                  】，预计将导致布伦特原油价格短期波动幅度约{" "}
            ...
            <div
              className="flex-1 overflow-y-auto p-5 space-y-5 scroll-smooth scrollbar-none relative"
              ref={scrollRef}
            >
              {messages.length === 0 && !isTyping ? (
                <div className="h-full flex flex-col">
                  <h3 className="text-base font-medium text-white/70 mb-14 ml-1">
                    AI 注入事件
                  </h3>
                  ...
                  {isTyping && (
                    <div className="flex flex-col items-start w-full">
                      <div className="max-w-[90%] rounded-2xl p-4 text-sm text-slate-400 bg-white/10 backdrop-blur-md border border-white/10 shadow-xl rounded-tl-sm flex flex-col gap-3 w-full animate-pulse">
                        ...
                        <div
                          className={`grid transition-all duration-300 ease-in-out ${thinkingExpanded ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}
                        >
                          <div className="overflow-hidden">
                            <div className="space-y-2 mt-2 bg-black/20 rounded-xl p-3 border border-white/5">
                              <div
                                className={`flex items-center justify-between text-[11px] p-2 rounded-lg transition-colors ${injectionProgress >= 1 ? "text-green-400" : "text-white/40"}`}
                              >
                                <div className="flex items-center gap-2">
                                  {injectionProgress >= 1 ? (
                              ...
                              <div
                                className={`flex items-center justify-between text-[11px] p-2 rounded-lg transition-colors ${injectionProgress >= 2 ? "text-green-400" : "text-white/40"}`}
                              >
                                <div className="flex items-center gap-2">
                                  {injectionProgress >= 2 ? (
                                    <CheckCircle2 className="w-3.5 h-3.5" />
                              ...
                              <div
                                className={`flex items-center justify-between text-[11px] p-2 rounded-lg transition-colors ${injectionProgress >= 3 ? "text-green-400" : "text-white/40"}`}
                              >
                                <div className="flex items-center gap-2">
                                  {injectionProgress >= 3 ? (
                                    <CheckCircle2 className="w-3.5 h-3.5" />
